...
public class TemperatureConvertor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TempRadGroup = new javax.swing.ButtonGroup();
        ...
        TempRadGroup.add(FtoC);
        FtoC.setSelected(true);
        FtoC.setText("Fahrenheit into Celsius");

        TempRadGroup.add(CtoF);
        CtoF.setText("Celsius into Fahrenheit");

        jLabel3.setText("Enter the temperature to convert: ");

        jLabel4.setText("The temperature converts to: ");

        convertBtn.setText("Convert Temperature");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGap(76, 76, 76))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addComponent(convertBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(80, 80, 80))))
        );
    ...
    private void convertBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_convertBtnActionPerformed
        ...
        if (this.input.getText().equals("")) {
            ...
            temperature = Double.valueOf(this.input.getText());
            if (this.CtoF.isSelected()) {
                converted = TemperatureConvMain.TemperatureConvertor(temperature, true);
                this.result.setText(String.valueOf(df2.format(converted)) + " degrees Farhenheit");
            } else {
                converted = TemperatureConvMain.TemperatureConvertor(temperature, false);
                this.result.setText(String.valueOf(df2.format(converted)) + " degrees celsius");
            }
        }
    ...
    private javax.swing.ButtonGroup TempRadGroup;
